...
# Selecionar os hospitais da microrregião 4
...
selected_hospital_names <- hospital_names[microrregiao4_index]
selected_hospital_links <- hospital_links[microrregiao4_index]

# Verificar URL dos hospitais
print("URLs dos hospitais da microrregião 4:")
print(hospital_url)
...
#write.xlsx(df, "convocacoes_ebserh_microrregiao.xlsx", rowNames = FALSE)
